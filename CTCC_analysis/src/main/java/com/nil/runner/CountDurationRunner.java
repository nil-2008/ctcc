...
import com.nil.mapper.CountDurationMapper;
import com.nil.outputformat.MysqlOutputFormat;
import com.nil.reducer.CountDurationReducer;
...
public class CountDurationRunner implements Tool {
  ...
  private void initHBaseInputConfig(Job job) {
    ...
    Admin admin = null;
    try {
      String tableName = "ctcc2:calllog";
      ...
      TableMapReduceUtil.initTableMapperJob(
          tableName, scan, CountDurationMapper.class, ComDimension.class, Text.class, job, true);
